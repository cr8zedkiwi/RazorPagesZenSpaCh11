...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241028195623_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 28, 15, 56, 23, 93, DateTimeKind.Local).AddTicks(9626),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 10, 28, 15, 56, 23, 93, DateTimeKind.Local).AddTicks(9684),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 28, 15, 56, 23, 93, DateTimeKind.Local).AddTicks(9687),
                            ServicesID = 5
                        });
                });
